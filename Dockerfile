...
# 0.4.6 - 0.5.1
# ARG BARRETENBERG_BACK_VERSION=0.4.6 
# RUN wget https://github.com/AztecProtocol/barretenberg/archive/refs/tags/barretenberg-v${BARRETENBERG_BACK_VERSION}.tar.gz && \
...
RUN python verifier.py --write_vk -v -c circuit.json -b ${BACKEND_PATH} -t circuit
